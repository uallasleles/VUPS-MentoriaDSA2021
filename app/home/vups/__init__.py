...
def get_data(
    ...
    if file_extension == ".parquet":
        _PARAMS = {"path": filepath_or_buffer, "columns": usecols}
...
def plot_year_taxs(UF="ES", df=datasets.arrecadacao_1998_a_2001()):
    ...
    df = group_by(df, ["sg_uf", "ano_arrecadacao", "NM_TIP_ARRECAD"]).sort_values(
...
def plot_comp_tributos_cidades_norm(
    list_cidades=["ARACRUZ", "ANCHIETA", "CARIACICA", "GUARAPARI", "LINHARES", "PIUMA"]
):
    # import pandas as pd
    # import datetime
